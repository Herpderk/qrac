...
from qrac.estimation import SetMembershipEstimator, LinearMHE
...
def main():
    ...
    # init estimator
    Q_mhe = 1*np.diag([100,100,100,100,1,1,1,100,100,100])
    ...
    mhe = LinearMHE(
        ...
        time_step=ctrl_T, num_nodes=num_nodes_mhe, rti=rti,
