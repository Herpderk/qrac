...
def main():
    ...
    np.save(
        "/home/derek/dev/my-repos/qrac/experiments/urop/lemniscate/data/nmpc_err.npy",
        err
    )
    ...
    # plot
    sim.get_animation(
        f"/home/derek/dev/my-repos/qrac/experiments/urop/lemniscate/figures/nmpc_lem_{rmse}.gif"
    )
