...
def main():
    ...
    resultsname = "/home/derek/dev/my-repos/qrac/experiments/urop/lemniscate/results/smlms_err.npy"
    ...
    # plot
    sim.get_animation(
        f"/home/derek/dev/my-repos/qrac/experiments/urop/lemniscate/results/smlms_lem_{rmse}"
    )
