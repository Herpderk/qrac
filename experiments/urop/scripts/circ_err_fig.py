...
def main(
    ...
    figname = f"/home/derek/dev/my-repos/qrac/experiments/urop/figures/circ_err_{st}-{et}.png"
    ...
    xref = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_xref.npy")
    nmpc_traj = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_nmpc_traj.npy")
    l1_traj = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_l1_traj.npy")
    mhe_traj = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_mhe_traj.npy")
    smlms_traj = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_smlms_traj.npy")
    #linmhe_traj = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_linmhe_traj.npy")
    smmhe_traj = np.load("/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_smmhe_traj.npy")
    ...
    plt.title("Circle Tracking Errors")
    plt.legend()
