...
def main():
    ...
    trajname = "/home/derek/dev/my-repos/qrac/experiments/urop/data/circ_mhe_traj.npy"
    figname = "/home/derek/dev/my-repos/qrac/experiments/urop/figures/circ_mhe.png"
    ...
    p_max = np.zeros(4)
    p_max[0] = 2 * inacc.m
    p_max[1] = 10 * inacc.Ixx
    p_max[2] = 10 * inacc.Iyy
    p_max[3] = 10 * inacc.Izz
